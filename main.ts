...
function runningAnimation (marathonOrSprint: boolean, animationPauseDuration: number) {
...
function sportAnimation (whichSport: number, swimOrRun: boolean) {
    if (swimOrRun) {
        ...
        // marathon
        // 
        runningAnimation(true, 60)
    } else if (whichSport == 1) {
        // sprinting
        runningAnimation(false, 30)
    } else if (whichSport == 2) {
        soccerAnimation()
    }
}
